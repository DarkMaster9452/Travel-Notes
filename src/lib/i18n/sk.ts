...
export const sk: Messages = {
  ...
  proof: {
    readerLooksFor: "Čo kontrolór hľadá",
    whatHappened: "Čo sa stalo",
    whatHappenedHint: "Popis dňa vlastnými slovami, nie titulok k fotke.",
    notePlaceholder: "O 04:40 sme vyrazili z parkoviska, aby sme stihli svetlo na hrebeni…",
    required: "Povinné",
    optional: "Nepovinné",
    photographs: "Fotky",
    photographsHint: "Fotky, na ktorých je terén — kde si bol, nielen tvoja tvár.",
    upToFour: "Najviac štyri",
    addPhoto: "Pridať fotku",
    removePhoto: "Odstrániť túto fotku",
    uploading: "Nahráva sa…",
    uploadFailed: "Tú fotku sa nepodarilo nahrať.",
    yourFigures: "Tvoje čísla",
    figuresHint:
      "Čísla, ktoré sedia s tým, čo quest žiadal, alebo riadok o tom, prečo nesedia.",
    distance: "Vzdialenosť",
    ascent: "Prevýšenie",
    movingTime: "Čas v pohybe",
    strava: "Aktivita na Strave",
    stravaConnected: "Strava prepojená",
    stravaRead: "Čísla prevzaté z aktivity.",
    stravaUnreadable: "Tú aktivitu sa nepodarilo načítať.",
    stravaBadLink: "Toto musí byť celý odkaz.",
    retreat: "Odovzdať ako návrat",
    retreatHint: "Návrat povedaný na rovinu. Otočiť sa je rozhodnutie, nie zlyhanie.",
    ifApproved: "Ak to schvália",
    file: "Odovzdať",
    fileRetreat: "Odovzdať návrat",
    filed: "Odovzdané. Kontrolór sa k tomu dostane.",
    retreatFiled: "Návrat odovzdaný. Kontrolór sa k tomu dostane.",
    failed: "Toto sa nepodarilo odovzdať.",
