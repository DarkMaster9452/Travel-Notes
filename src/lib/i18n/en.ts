...
export const en = {
  ...
  proof: {
    ...
    whatHappenedHint: "An account of the day in your own words, not a caption.",
    notePlaceholder: "Left the car park at 04:40 to catch the light on the ridge…",
    required: "Required",
    optional: "Optional",
    photographs: "Photographs",
    photographsHint: "Photographs with ground in them — where you were, not just your face.",
    upToFour: "Up to four",
    addPhoto: "Add a photograph",
    removePhoto: "Remove this photograph",
    uploading: "Uploading…",
    uploadFailed: "That photograph would not upload.",
    yourFigures: "Your figures",
    figuresHint:
    ...
    stravaRead: "Figures taken from the activity.",
    stravaUnreadable: "That activity could not be read.",
    stravaBadLink: "That needs to be a full link.",
    retreat: "File this as a retreat",
    retreatHint: "A retreat said plainly. Turning back is a judgement, not a failure.",
    ifApproved: "If this is approved",
    file: "File it",
    fileRetreat: "File the retreat",
    filed: "Filed. A reader will get to it.",
    retreatFiled: "Retreat filed. A reader will get to it.",
    failed: "That would not file.",
